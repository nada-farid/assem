    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.courses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('center') ? 'is-invalid' : '' }}" name="center_id" id="center_id" required>
                    @foreach($centers as $id => $entry)
                        <option value="{{ $id }}" {{ old('center_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_weekly') ? 'is-invalid' : '' }}" type="text" name="duration_weekly" id="duration_weekly" value="{{ old('duration_weekly', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('beneficiary_count') ? 'is-invalid' : '' }}" type="number" name="beneficiary_count" id="beneficiary_count" value="{{ old('beneficiary_count', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('goals') ? 'is-invalid' : '' }}" name="goals" id="goals">{!! old('goals') !!}</textarea>
                @if($errors->has('goals'))
                    <div class="invalid-feedback">
                        {{ $errors->first('goals') }}
                    </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('avaliable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="avaliable" id="avaliable" value="1" {{ old('avaliable', 0) == 1 || old('avaliable') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('goal') ? 'is-invalid' : '' }}" name="goal_id" id="goal_id" required>
                    @foreach($goals as $id => $entry)
                        <option value="{{ $id }}" {{ old('goal_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('goal'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('assistant') ? 'is-invalid' : '' }}" type="text" name="assistant" id="assistant" value="{{ old('assistant', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('support_value') ? 'is-invalid' : '' }}" type="number" name="support_value" id="support_value" value="{{ old('support_value', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_supported') ? 'is-invalid' : '' }}" type="number" name="number_supported" id="number_supported" value="{{ old('number_supported', '') }}" step="1" required>
