    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.courses.update", [$course->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('center') ? 'is-invalid' : '' }}" name="center_id" id="center_id" required>
                    @foreach($centers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('center_id') ? old('center_id') : $course->center->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" id="type">
                    ...
                    @foreach(App\Models\Course::TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('type', $course->type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('type'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('video_url') ? 'is-invalid' : '' }}" type="text" name="video_url" id="video_url" value="{{ old('video_url', $course->video_url) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_weekly') ? 'is-invalid' : '' }}" type="text" name="duration_weekly" id="duration_weekly" value="{{ old('duration_weekly', $course->duration_weekly) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('beneficiary_count') ? 'is-invalid' : '' }}" type="number" name="beneficiary_count" id="beneficiary_count" value="{{ old('beneficiary_count', $course->beneficiary_count) }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('goals') ? 'is-invalid' : '' }}" name="goals" id="goals">{!! old('goals', $course->goals) !!}</textarea>
                @if($errors->has('goals'))
                    <div class="invalid-feedback">
                        {{ $errors->first('goals') }}
                    </div>
            ...
            <div class="form-group">
                <label class="required" for="video_background">{{ trans('cruds.course.fields.video_background') }}</label>
                <div class="needsclick dropzone {{ $errors->has('video_background') ? 'is-invalid' : '' }}" id="video_background-dropzone">
                </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('avaliable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="avaliable" id="avaliable" value="1" {{ $course->avaliable || old('avaliable', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="avaliable">{{ trans('cruds.course.fields.avaliable') }}</label>
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_at') ? 'is-invalid' : '' }}" type="text" name="start_at" id="start_at" value="{{ old('start_at', $course->start_at) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end_at') ? 'is-invalid' : '' }}" type="text" name="end_at" id="end_at" value="{{ old('end_at', $course->end_at) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('goal') ? 'is-invalid' : '' }}" name="goal_id" id="goal_id" required>
                    @foreach($goals as $id => $entry)
                        <option value="{{ $id }}" {{ (old('goal_id') ? old('goal_id') : $course->goal->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('goal'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('assistant') ? 'is-invalid' : '' }}" type="text" name="assistant" id="assistant" value="{{ old('assistant', $course->assistant) }}">
                @if($errors->has('assistant'))
                    <div class="invalid-feedback">
                        {{ $errors->first('assistant') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.course.fields.assistant_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('supporter') ? 'is-invalid' : '' }}" name="supporter_id" id="supporter_id" required>
                    @foreach($supporters as $id => $entry)
                        <option value="{{ $id }}" {{ (old('supporter_id') ? old('supporter_id') : $course->supporter->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.course.fields.supporter_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="support_value">{{ trans('cruds.course.fields.support_value') }}</label>
                <input class="form-control {{ $errors->has('support_value') ? 'is-invalid' : '' }}" type="number" name="support_value" id="support_value" value="{{ old('support_value', $course->support_value) }}" step="0.01" required>
                @if($errors->has('support_value'))
                    <div class="invalid-feedback">
                        {{ $errors->first('support_value') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.course.fields.support_value_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="number_supported">{{ trans('cruds.course.fields.number_supported') }}</label>
                <input class="form-control {{ $errors->has('number_supported') ? 'is-invalid' : '' }}" type="number" name="number_supported" id="number_supported" value="{{ old('number_supported', $course->number_supported) }}" step="1" required>
                @if($errors->has('number_supported'))
                    <div class="invalid-feedback">
                        {{ $errors->first('number_supported') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.course.fields.number_supported_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="location">{{ trans('cruds.course.fields.location') }}</label>
                <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text" name="location" id="location" value="{{ old('location', $course->location) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="text" name="url" id="url" value="{{ old('url', $course->url) }}">
                @if($errors->has('url'))
                    <div class="invalid-feedback">
                        {{ $errors->first('url') }}
                    </div>
