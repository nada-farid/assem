...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.chat-responses.store') }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="response" id="reply" class="form-control" rows="4" required></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-check {{ $errors->has('is_quick') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="is_quick" id="is_quick" value="1" {{ old('is_quick' == 1 ? 'checked' : '' )}}>
