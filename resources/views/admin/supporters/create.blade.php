    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.supporters.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('official_name') ? 'is-invalid' : '' }}" type="text" name="official_name" id="official_name" value="{{ old('official_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('official_phone') ? 'is-invalid' : '' }}" type="number" name="official_phone" id="official_phone" value="{{ old('official_phone', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('official_email') ? 'is-invalid' : '' }}" type="email" name="official_email" id="official_email" value="{{ old('official_email') }}">
