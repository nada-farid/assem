...
@section('content')
    @can('association_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.associations.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.association.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.association.title_singular') }} {{ trans('global.list') }}
        </div>
        ...
        $(function() {
            ...
            @can('association_delete')
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('admin.associations.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.associations.index') }}",
                columns: [{
                        data: 'placeholder',
                        name: 'placeholder'
                    },
            ...
            let table = $('.datatable-Association').DataTable(dtOverrideGlobals);
