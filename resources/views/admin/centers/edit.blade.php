                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text"
                            name="name" id="name" value="{{ old('name', $center->name) }}" required>
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email"
                            name="email" id="email" value="{{ old('email', $center->user->email) }}" required>
                        @if ($errors->has('email'))
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
                            </div>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text"
                            name="phone" id="phone" value="{{ old('phone',$center->phone) }}" required>
                        @if ($errors->has('phone'))
                            <div class="invalid-feedback">
                                {{ $errors->first('phone') }}
                            </div>
                    ...
                    <div class="form-group col-md-6">
                        <label class="required"
                            for="specialization">{{ trans('cruds.center.fields.specialization') }}</label>
                        <input class="form-control {{ $errors->has('specialization') ? 'is-invalid' : '' }}" type="text"
                            name="specialization" id="specialization"
                            value="{{ old('specialization', $center->specialization) }}" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('experience_years') ? 'is-invalid' : '' }}"
                            type="number" name="experience_years" id="experience_years"
                            value="{{ old('experience_years', $center->experience_years) }}" step="1">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('beneficiar_count') ? 'is-invalid' : '' }}"
                            type="number" name="beneficiar_count" id="beneficiar_count"
                            value="{{ old('beneficiar_count', $center->beneficiar_count) }}" step="1">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description"
                            id="description">{!! old('description', $center->description) !!}</textarea>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('facebook_link') ? 'is-invalid' : '' }}" type="text"
                            name="facebook_link" id="facebook_link"
                            value="{{ old('facebook_link', $center->facebook_link) }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('twitter_link') ? 'is-invalid' : '' }}" type="text"
                            name="twitter_link" id="twitter_link" value="{{ old('twitter_link', $center->twitter_link) }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('linked_in') ? 'is-invalid' : '' }}" type="text"
                            name="linked_in" id="linked_in" value="{{ old('linked_in', $center->linked_in) }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text"
                            name="location" id="location" value="{{ old('location', $center->location) }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('license_number') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('license_number', $center->license_number) }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('end_date', $center->end_date) }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="needsclick dropzone {{ $errors->has('license_image') ? 'is-invalid' : '' }}"
                            id="license_image-dropzone">
                        </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('director_name') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('director_name', $center->director_name) }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('director_phone') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('director_phone', $center->director_phone) }}" step="1">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('director_email') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('director_email', $center->director_email) }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('coordinator_name') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('coordinator_name', $center->coordinator_name) }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('coordinator_phone') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('coordinator_phone', $center->coordinator_phone) }}" step="1">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('coordinator_email') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('coordinator_email', $center->coordinator_email) }}">
                            ...
                            return loader.file
                                .then(function(file) {
                                    return new Promise(function(resolve, reject) {
                                        ...
                                        xhr.open('POST',
                                            '{{ route('admin.centers.storeCKEditorImages') }}',
                                            true);
