            ...
            <form method="POST" action="{{ route('admin.centers.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="required"
                        for="experience_years">{{ trans('cruds.center.fields.experience_years') }}</label>
                ...
                <div class="form-group">
                    <label class="required"
                        for="beneficiar_count">{{ trans('cruds.center.fields.beneficiar_count') }}</label>
                    <input class="form-control {{ $errors->has('beneficiar_count') ? 'is-invalid' : '' }}" type="number"
                        name="beneficiar_count" id="beneficiar_count" value="{{ old('beneficiar_count', '') }}"
                        step="1" required>
