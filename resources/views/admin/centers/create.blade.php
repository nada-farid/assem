...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.center.title_singular') }}
        </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('specialization') ? 'is-invalid' : '' }}" type="text"
                            name="specialization" id="specialization" value="{{ old('specialization', '') }}" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('experience_years') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('experience_years', '') }}" step="1">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('beneficiar_count') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('beneficiar_count', '') }}" step="1">
