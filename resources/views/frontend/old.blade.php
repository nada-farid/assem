...
<script>
        ...
        for (const input of currentInputs) {
            if (input.hasAttribute("required") && !input.value.trim()) {
                ...
                if (!input.nextElementSibling || !input.nextElementSibling.classList.contains('text-danger')) {
                    ...
                    errorDiv.innerText = 'هذا الحقل مطلوب';
    ...
    function copyDirectorData() {
        const isChecked = document.getElementById("copyDirectorToCoordinator").checked;

        if (entityType === 'center') {
            if (isChecked) {
                document.querySelector('[name="center_coordinator_name"]').value = document.querySelector('[name="center_director_name"]').value;
                document.querySelector('[name="center_coordinator_phone"]').value = document.querySelector('[name="center_director_phone"]').value;
                document.querySelector('[name="center_coordinator_email"]').value = document.querySelector('[name="center_director_email"]').value;
            }
        } else if (entityType === 'association') {
            if (isChecked) {
                document.querySelector('[name="coordinator_name"]').value = document.querySelector('[name="director_name"]').value;
                document.querySelector('[name="coordinator_phone"]').value = document.querySelector('[name="director_phone"]').value;
                document.querySelector('[name="coordinator_email"]').value = document.querySelector('[name="director_email"]').value;
            }
        }
    }
