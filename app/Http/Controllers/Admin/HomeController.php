...
class HomeController
{
    public function index()
    {
        ...
        $topAssociations = CourseStudent::select('association_id', DB::raw('COUNT(*) as total'))
            ->join('associations', 'course_students.association_id', '=', 'associations.id')
        ...
        $monthlyRequests = CourseStudent::select(
